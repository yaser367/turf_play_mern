        ...
        <div className={styles.glass}>
          ...
          <form className='py-1' onSubmit={formik.handleSubmit}>
            ...
            <div className="textbox flex flex-col items-center gap-6">
              <input {...formik.getFieldProps('password')} className={styles.textbox} name='password' type="password" placeholder='Password'/>
              <div  >
            ...
            <div className="text-center py-4">
              <span className='text-grey-500'>
                Forgot Password? <a onClick={resendOtphandler} className='text-red-500'>Change</a>
              </span>
            </div>
          </form>
        </div>
