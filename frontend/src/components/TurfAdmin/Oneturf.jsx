  ...
  return (
    ...
    <div className=' mt-7 pb-5 p-3 '>
      <div className=''>
        ...
        <img onMouseEnter={handleHover} onMouseLeave={handleExit}  className='w-[900px] h-[500px] mx-auto' src={turf1} alt="" />
        <div className='absolute top-[60%]  h-full left-[48%]'>
          {hover && 
          <button onMouseEnter={handleHover} class="relative inline-flex items-center justify-center p-0.5 mb-2  overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
      ...
      <div class="flex space-x-2 justify-center">
        ...
        <p className='font-bold text-end text-blue-500 cursor-pointer'>Edit</p>
        <p className='font-bold text-2xl text-center'>Available Sports</p>
        <div className='flex mt-3 '>
        
        <div className='mx-10 w-[100px] h-[100px] '>
          <img className='w-[100px] h-[100px] mt-3 rounded-md ' src={footballGame} alt="" />
          <p className='text-center font-bold'>Football</p>
          <p className='text-center'>5s</p>
        </div>
        <div className='mx-10 w-[100px] h-[100px]'>
          <img className='w-[100px] h-[100px] mt-3 rounded-md ' src={cricket} alt="" />
