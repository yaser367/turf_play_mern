  ...
  return (
    ...
    <ul className='hidden md:flex'>
      ...
      <li className=' pl-6 cursor-pointer font-bold' >        
        <button onClick={openModal} type="button" class="inline-block px-6 py-2 border-2 border-green-500 text-green-500 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Add Turf</button>
    ...
    <img className='w-[100px] m-4 ' src={MainLogo} alt="" />
      ...
      <li className='p-4 border-b border-gray-600'><button type="button" class="inline-block px-6 py-2 border-2 border-green-500 text-green-500 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Add Turf</button></li>
      </ul>
    </div>
</div>
</div>
