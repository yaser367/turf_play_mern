...
const TurfAdminmng = () => {
  ...
  return (
    ...
    <p className='font-bold text-2xl text-gray-700 ml-4'>Turf Admin Management</p>
      ...
      <DataTable  message={message} modal={modal} setModal={setModal} turfAdmin={turfAdmin} handleUpdate={handleUpdate} id={id}  Header={modalHeader} users={users} showModal={showModal} file={file}/>
    </div>
